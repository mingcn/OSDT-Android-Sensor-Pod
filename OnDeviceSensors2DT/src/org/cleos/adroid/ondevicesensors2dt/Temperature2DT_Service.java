...
public class Temperature2DT_Service extends Service {

	private String TAG = getClass().getSimpleName();
	private String name = "Temperature";
	private SensorManager mSM;
	private Sensor sensor;
	private Temperature2DT_Thread thread;
	private String ipp;
	...
	private void spawThread() {
		...
		String[] units = { "Celcius" };

		String[] MIMEs = { "application/octet-stream" };

		thread = new Temperature2DT_Thread(name, this, ipp, mSM, sensor);
	...
	private Sensor sSensor(SensorManager sm) {
		if (sm.getDefaultSensor(Sensor.TYPE_TEMPERATURE) != null) {
			return sm.getDefaultSensor(Sensor.TYPE_TEMPERATURE);
		} else {
