...
public class Pressure2DT_Thread extends Thread implements SensorEventListener {
	...
	public Pressure2DT_Thread(String name, Context context, String ipp, SensorManager mSM, Sensor mS){
		this.name = name;
	...
	@Override
	  public final void onSensorChanged(SensorEvent event) {
	    ...
	    data[0] = Float.toString(millibars_of_pressure);
