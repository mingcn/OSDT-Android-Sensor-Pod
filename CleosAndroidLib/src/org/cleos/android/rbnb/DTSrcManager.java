...
public class DTSrcManager {
	...
	public DTSrcManager(Context context, /*DataLineProcessor_x dlp_x,*/
		...
		//this.dlp_x = dlp_x;
		this.log = log;
		this.src = new Source(100, "append", 10000000);
	}
	...
	public void connectToDT(String address, String name) {
		// The AsyncTask to connectToDT
		new RBNBConnectHelper().connectToDT(this.contex, /*this.dlp_x,*/ this.log,
				this.src, address, name);
	}
